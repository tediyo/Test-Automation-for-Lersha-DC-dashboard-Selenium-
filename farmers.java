...
public class farmers {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Wait for the dropdown to appear and locate the dropdown icon
            WebElement dropdownIcon = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//svg[contains(@class, 'lucide-chevron-down')]")));
            dropdownIcon.click();
